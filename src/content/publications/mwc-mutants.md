...
links:
  - name: PDF
    url: 'Chure2019.pdf'
  - name: Publisher
    url: 'https://www.pnas.org/doi/full/10.1073/pnas.1907869116'
  - name: Paper Website
    url: 'http://rpgroup.caltech.edu/mwc_mutants' 
  - name: GitHub Repository
    url: 'https://github.com/rpgroup-pboc/mwc_mutants'
abstract: >
    ...
    mutations in the DNA binding and inducer binding domains. We find that the
    change in gene expression due to a point mutation can be captured by modifying
    only the model parameters that describe the respective domain of the wild-type
    ...
    with quantitative accuracy given knowledge of the single mutants, providing an
    avenue for identifying and quantifying epistatic interactions.
---

# Notes

* Chosen as an "Editor's Suggestion" in the August 2020 issue of PRE
