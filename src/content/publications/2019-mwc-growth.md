...
authors:
  - name: Griffin Chure
  - name: Zofii A. Kaczmarek
  - name: Rob Phillips
    corr: true
journal: 'bioRxiv'
tags: ['gene regulation', 'statistical mechanics']
DOI: '10.1101/2019.12.19.878462 '
links:
  - name: PDF
    url: 'Chure2019b.pdf'
  - name: Publisher
    url: 'https://www.biorxiv.org/content/10.1101/2019.12.19.878462v1'
  - name: Paper Website
    url: 'https://rpgroup.caltech.edu/mwc_growth' 
  - name: GitHub Repository
    url: 'https://github.com/rpgroup-pboc/mwc_growth'
abstract: >
    ...
    Controlling the growth rate via modulating the available carbon source or growth
    temperature, we measure the level of gene expression from a LacI-regulated
    promoter where the LacI copy number is directly measured in each condition,
    permitting parameter-free prediction of the expression level. The
    ...
    conditions, indicating that the bio-physical parameters are indifferent to the
