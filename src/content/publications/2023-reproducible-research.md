...
authors:
  - name: Griffin Chure
journal: 'arXiv'
tags: ['reproduciblity', 'software', 'perspective']
...
links:
  ...
  - name: GitHub Template Repository
    url: 'https://github.com/gchure/reproducible_research'
abstract: >
    The ubiquity of computation in modern scientific research inflicts new
    challenges for reproducibility. While most journals now require code and data be
    made available, the standards for organization, annotation, and validation
    ...
    computational analysis and wet-lab experiments is commonplace. Modern tools used
    in scientific workflows (such as GitHub repositories) lend themselves well to
    this philosophy where reproducibility begins at project inception, not
